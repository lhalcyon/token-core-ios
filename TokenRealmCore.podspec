#
#  Be sure to run `pod spec lint TokenRealmCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Token Core Library powering TokenRealm iOS app.
  DESC

  s.homepage     = "https://github.com/lhalcyon/token-core-ios"
  ...
  s.source       = { :git => "https://github.com/lhalcyon/token-core-ios.git", :tag => "#{s.version}" }
